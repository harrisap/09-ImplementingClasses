...
class Point(object):
   ...
   def move_to(self,x,y):
       ...
       self.totalx = self.totalx + self.x
       self.totaly = self.totaly + self.y
   ...
   def closer_to(self,point1,point2):
       p1final = point1.get_distance_from(self)
       p2final = point2.get_distance_from(self)

       # testing1x = point1.x - self.x
       # testing1y = point1.y - self.y
       # testing2x = point2.x - self.x
       # testing2y = point2.y - self.y
       #
       # item1 = math.sqrt((((testing1x)**2) + ((testing1y)**2)))
       # item2 = math.sqrt((((testing2x) ** 2) + ((testing2y) ** 2)))
